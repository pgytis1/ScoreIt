...
namespace ScoreIT.Migrations
{
    ...
    [Migration("20161030112450_AddRelationshipBetweenPlayerAndUser")]
    partial class AddRelationshipBetweenPlayerAndUser
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ScoreIT.Models.Player", b =>
                {
                    b.HasOne("ScoreIT.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
